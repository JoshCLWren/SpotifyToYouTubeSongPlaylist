...
class Playlist:
    ...
    def __init__(self, spotify_id, spotify, youtube=None, youtube_playlists=None, spotify_playlists=None):
    ...
    def place_songs_in_playlist(self):
        ...
        for tune in self.tracks:
            ...
            song.youtube_id = cached_song["video_id"] or song.get_song_youtube()
    ...
    def create_youtube_playlist(self, name):
        ...
        playlist = prevent_429(func=request.execute)
        try:
            self.youtube_id = playlist["id"]
            self._update_youtube_cache(self.youtube_id, name)
